...
set objrs01 = objConn01.execute("select * from fornecedores where codfor="&codfor&" ")
...
{
  if (form.vendedor.value == "")
  { 
	  alert("Por favor digite o Nome do Vendedor"); form.vendedor.focus(); return; 
  }  
  if (form.empresa.value == "")
  { 
	  alert("Por favor digite a Empresa"); form.empresa.focus(); return; 
  }  
  if (form.telefone.value == "")
  { 
	  alert("Por favor digite o telefone"); form.telefone.focus(); return; 
  }     
  ...
  form.submit();
                ...
                caracteres especiais : &quot; ' &amp; % ( ) &lt; &gt; )</strong></font><br>
				  <form action="fornecedores_editar2.asp" method="get" name="form" id="form" >
                    <input name="codfor" type="hidden" value="<%=codfor%>">
					  ...
					  <table width="650" border="0" cellspacing="0" cellpadding="0">
                        <tr valign="top">
                          <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="linkA">
                              ...
                              <tr>
                                <td bgcolor="#CCCCCC"><strong>NOME VENDEDOR </strong></td>
                              </tr>
                              <tr>
                                <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                              </tr>
                              <tr>
                                <td height="18"><input name="vendedor" type="text" id="vendedor" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" value="<%=vendedor%>" size="60" maxlength="50"></td>
                              </tr>
                              <tr>
                                <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                              </tr>
                              ...
                              <tr>
                                <td bgcolor="#FFFFFF"><input name="empresa" type="text" id="empresa" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" value="<%=empresa%>" size="50" maxlength="40"></td>
                              </tr>
                              <tr>
                                <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                              </tr>
                              ...
                              <tr>
                                <td><input name="telefone" type="text" id="telefone" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" value="<%=telefone%>" size="25" maxlength="20"></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td><input name="fax" type="text" id="fax" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA" value="<%=fax%>" size="25" maxlength="20"></td>
                              </tr>
                              ...
                              <tr>
                                <td bgcolor="#CCCCCC"><strong>COTA&Ccedil;&Atilde;O</strong> </td>
                              </tr>
                              <tr>
                                <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                              </tr>
                              <tr>
                                <td bgcolor="#FFFFFF"><input name="fora" type="radio" value="sim"  <% if fora="sim" then%> checked <%end if%>>
                                  SIM
                                  <input name="fora" type="radio" value="não" <% if fora="não" then%> checked <%end if%>>
                                  N&Atilde;O</td>
                              </tr>
                              <tr>
                                <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
