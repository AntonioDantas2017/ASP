...
function ValidateOrder(form)
{
  ...
  form.submit();
                ...
                <br>
                  <form method="GET" ACTION="fornecedores_inserir2.asp" name="form" id="form">
                    ...
                    <tr valign="top"> 
                      <td width="100%">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="linkA">
                          ...
                          <tr> 
                            <td height="18"><input name="vendedor" type="text" id="vendedor" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" size="60" maxlength="50"></td>
                          </tr>
                          <tr> 
                            <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                          </tr>
						  ...
						  <tr>
						    <td bgcolor="#FFFFFF"><input name="empresa" type="text" id="empresa" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" size="50" maxlength="40"></td>
					      </tr>
                          <tr> 
                            <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                          </tr>							  
						  ...
						  <tr>
						    <td><input name="telefone" type="text" id="telefone" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" size="25" maxlength="20"></td>
					      </tr>
						  <tr>
						  ...
						  <tr>
						    <td><input name="fax" type="text" id="fax" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA" size="25" maxlength="20"></td>
					      </tr>
						  ...
						  <tr>
						    <td bgcolor="#FFFFFF"><input name="fora" type="radio" value="sim" checked>
SIM
  <input name="fora" type="radio" value="não">
  N&Atilde;O</td>
					      </tr>
						  						                            <tr> 
                            <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                          ...
                          <tr>
                          <td bgcolor="#FFFFFF"><textarea name="obs" cols="30" rows="2" id="obs" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA"></textarea></td>
                          </tr>
                          <tr> 
                            <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                          </tr>	
