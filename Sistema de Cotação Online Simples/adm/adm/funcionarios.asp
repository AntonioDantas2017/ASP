                  ...
                  <td bgcolor="#BBECB1"><div align="center">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" class=linka>
                        <tr> 
                          ...
                          <%if ((nivel_aux="2")) then%><td width="30"><div align="center"><strong><a href="funcionarios_inserir.asp?listar=<%=listar%>&ordem=<%=ordem%>&pesquisa=<%=pesquisa%>"><img src="imagem/icones_insere.gif" alt="insere funcionario nesta tabela" width="20" height="20" border="0"></a></strong></div></td><%end if%>
      ...
      <tr> 
        <td bgcolor="#999999"><table width="700" border="0" cellpadding="1" cellspacing="1" CLASS=LINKA>
            <tr valign="top" bgcolor="#FFFFFF" class="linkA5"> 
              ...
              <%'if ((nivel_aux="2")) then%><td width="34"><div align="center"><strong>Ed</strong></div></td>
...
%>
             ...
             <td width="34"><div align="center"> 
                <%if ((nivel_aux="2")) then%>   <a href="funcionarios_editar.asp?codfunc=<%=codfunc%>&listar=<%=listar%>&ordem=<%=ordem%>&pesquisa=<%=pesquisa%>"><img src="imagem/icones_edita.gif" alt="Edita o Registro deste funcionario" width="20" height="20" border="0"></a> <%end if%>
              </div></td>
	...
	function confirmar()
	{
	   return (confirm('Deseja apagar este registro?'))
                            ...
                            <%if ((nivel_aux="2")) then%> <input NAME="delete" TYPE="image" OnClick="return confirmar()" SRC="imagem/icones_apaga.gif" alt="Apaga o registro deste funcionario" WIDTH="20" HEIGHT="20"><%end if%>
                          </div></td>
                      </tr>
                    </form>
                  </table>
