...
if (Session("pagina_locatarios") <> 1 )or(Session("pagina_locatarios") <> 1)or(Session("pagina_locatarios") <> objrs01.PageCount )or(Session("pagina_locatarios") <> objrs01.PageCount) then
	...
	If Session("pagina_locatarios") <> objrs01.PageCount then
		response.write "&nbsp;"&"<a href=""imoveis.asp?Navegacao=Proxima&ordem="&ordem&"&filtro="&filtro&"&pesquisa="&pesquisa&"&listar="&listar&"""><img src='imagem/icones_proxima.gif' alt='Próxima tela' width='20' height='20' border='0'></a>"
	else
		response.write "&nbsp;"&"<img src='imagem/icones_proxima.gif'  alt='Próxima tela' width='20' height='20' border='0'>"
	End If
	If Session("pagina_locatarios") <> objrs01.PageCount then
		response.write "&nbsp;"&"<a href=""imoveis.asp?Navegacao=Ultima&ordem="&ordem&"&filtro="&filtro&"&pesquisa="&pesquisa&"&listar="&listar&"""><img src='imagem/icones_ultima.gif' alt='Última tela' width='20' height='20' border='0'></a>"
	else
