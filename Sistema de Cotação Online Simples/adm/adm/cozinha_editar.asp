...
set objrs01 = objConn01.execute("select * from cozinha where codcoz="&codcoz&" ")
...
function ValidateOrder(form)
{
  ...
  form.submit();
                ...
                caracteres especiais : &quot; ' &amp; % ( ) &lt; &gt; )</strong></font><br>
				  <form action="cozinha_editar2.asp" method="get" name="form" id="form" >
                    <input name="codcoz" type="hidden" value="<%=codcoz%>">
                      ...
                      <td width="100%"><div align="center"><table width="650" border="0" cellspacing="0" cellpadding="0">
                        <tr valign="top">
                          <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="linkA">
                              ...
                              <tr>
                                <td height="18"><input name="data" type="text" id="data" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" value="<%=data%>" size="15" maxlength="10"></td>
                              </tr>
                              <tr>
                                <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                              </tr>
                              ...
                              <tr>
                                <td bgcolor="#FFFFFF"><input name="valor" type="text" id="valor" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" value="<%=valor%>" size="15" maxlength="10"></td>
                              </tr>
