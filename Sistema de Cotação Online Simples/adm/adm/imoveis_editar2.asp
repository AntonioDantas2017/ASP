  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0" class=linka>
    <tr> 
      <td height="13" bgcolor="#CCCCCC"><div align="center"> <strong> ALTERA&Ccedil;&Atilde;O 
          DO CADASTRO DE IM&Oacute;VEL</strong></div></td>
    </tr>
  </table>
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr> 
...
codimo	= TRIM(Request ("codimo"))

sql = "update imoveis set rua='"&rua&"',numero='"&numero&"',bairro='"&bairro&"',cidade='"&cidade&"' where codimo = "&codimo&" "
'Response.Write(sql)
...
%>
                ...
                <div align="center"><strong> <br>
                  <br>
                  O cadastro do im&oacute;vel foi alterado com sucesso!<br>
                  <br>
                  <br>
                  <br>
                  <br>
                  <br>
                 <a href="imoveis.asp?listar=<%=listar%>&ordem=<%=ordem%>&pesquisa=<%=pesquisa%>&tipo=<%=tipo%>&filtro=<%=filtro%>&pesquisa2=<%=pesquisa2%>&datainicio=<%=datainicio%>&datafim=<%=datafim%>&filtro2=<%=filtro2%>"><img src="IMAGEM/botoes_principal.gif" alt="volta para a p&aacute;gina principal" width="75" height="19" border="0"></a></strong></div>
                <br>
                <br>
              </div></td>
          </tr>
