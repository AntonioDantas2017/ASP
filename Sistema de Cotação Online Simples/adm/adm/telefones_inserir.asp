...
function ValidateOrder(form)
{
  ...
  form.submit();
                ...
                <br>
                  <form method="GET" ACTION="telefones_inserir2.asp" name="form" id="form">
                    ...
                    <tr valign="top"> 
                      <td width="100%">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="linkA">
                          ...
                          <tr> 
                            <td height="18"><input name="nome" type="text" id="nome" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" size="60" maxlength="50"></td>
                          </tr>
                          <tr> 
                            <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                          </tr>
						  ...
						  <tr>
						    <td bgcolor="#FFFFFF"><input name="telefone" type="text" id="telefone" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA" size="25" maxlength="20"></td>
					      </tr>
						  <tr>
						  ...
						  <tr>
						    <td bgcolor="#FFFFFF"><input name="telefone2" type="text" id="telefone" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA" size="25" maxlength="20"></td>
					      </tr>
						  ...
						  <tr>
						    <td><input name="celular" type="text" id="celular" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA" size="25" maxlength="20"></td>
					      </tr>
						  <tr>
