 ...
 <form METHOD="get" ACTION="funcionarios_editar2.asp">
                  ...
                  <table width="650" border="0" cellspacing="0" cellpadding="0" CLASS=LINKA>
                    ...
                    <tr> 
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class=linka>
                          <tr> 
                            <td width="41%"><input name="login" type="text" id="login"  style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" value="<%=login%>" size="20" maxlength="10">
                            ( m&iacute;n. 03 caract. )</td>
                            <td width="26%"><strong> 
                              <input name="senha" type="password" id="senha"  style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" value="<%=senha%>" size="8" maxlength="6">
                            </strong>( 6 n&uacute;meros )</td>
                            <td width="33%"><input name="senha2" type="password" id="senha2"  style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" value="<%=senha%>" size="8" maxlength="6">
                              ( 6 n&uacute;meros )</td>
                          </tr>
                        </table></td>
                    </tr>
                  ...
                  <table width="650" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td bgcolor="#CCCCCC"><table width="650" border="0" cellspacing="1" cellpadding="1" CLASS=LINKA>
                          ...
                          <tr bgcolor="#FFFFFF">
                            <td width="29%">COTAC&Atilde;O:</td>
                            <td width="71%"><div align="center">
                                <input name="nivel_cotacao" type="radio" value="0" <%IF nivel_cotacao = "0" THEN%>checked<%END IF%>>
                              0-Sem Acesso
                              <input name="nivel_cotacao" type="radio" value="1" <%IF nivel_cotacao = "1" THEN%>checked<%END IF%>>
                              1-Consulta
                              <input name="nivel_cotacao" type="radio" value="2" <%IF nivel_cotacao = "2" THEN%>checked<%END IF%>>
                            2-Consulta+Altera&ccedil;&atilde;o </div></td>
                          </tr>
                          <tr bgcolor="#FFFFFF">
                            <td>MERCADO :</td>
                            <td><div align="center">
                                <input name="nivel_mercado" type="radio" value="0"  <%IF nivel_mercado = "0" THEN%>checked<%END IF%>>
                              0-Sem Acesso
                              <input name="nivel_mercado" type="radio" value="1" <%IF nivel_mercado = "1" THEN%>checked<%END IF%>>
                              1-Consulta
                              <input name="nivel_mercado" type="radio" value="2" <%IF nivel_mercado = "2" THEN%>checked<%END IF%>>
                              2-Consulta+Altera&ccedil;&atilde;o </div></td>
                          </tr>
                          <tr bgcolor="#FFFFFF">
                            <td>CONTRATOS  : </td>
                            <td><div align="center">
                                <input name="nivel_contratos" type="radio" value="0"  <%IF nivel_contratos = "0" THEN%>checked<%END IF%>>
                              0-Sem Acesso
                              <input name="nivel_contratos" type="radio" value="1"  <%IF nivel_contratos = "1" THEN%>checked<%END IF%>>
                              1-Consulta
                              <input name="nivel_contratos" type="radio" value="2" <%IF nivel_contratos = "2" THEN%>checked<%END IF%>>
                              2-Consulta+Altera&ccedil;&atilde;o </div></td>
                          </tr>
                          <tr bgcolor="#FFFFFF">
                            <td>FUNCION&Aacute;RIOS :</td>
                            <td><div align="center">
                                <input name="nivel_funcionarios" type="radio" value="0"  <%IF nivel_funcionarios = "0" THEN%>checked<%END IF%>>
                              0-Sem Acesso
                              <input name="nivel_funcionarios" type="radio" value="1" <%IF nivel_funcionarios = "1" THEN%>checked<%END IF%>>
                              1-Consulta
                              <input name="nivel_funcionarios" type="radio" value="2" <%IF nivel_funcionarios = "2" THEN%>checked<%END IF%>>
                              2-Consulta+Altera&ccedil;&atilde;o </div></td>
                          </tr>
                      </table></td>
                    </tr>
