...
set objrs01 = objConn01.execute("select * from telefones where codtel="&codtel&" ")
...
function ValidateOrder(form)
{
  ...
  form.submit();
                ...
                caracteres especiais : &quot; ' &amp; % ( ) &lt; &gt; )</strong></font><br>
				  <form action="telefones_editar2.asp" method="get" name="form" id="form" >
                    <input name="codtel" type="hidden" value="<%=codtel%>">
                  ...
                  <table width="650" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                      <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="linkA">
                          ...
                          <tr>
                            <td bgcolor="#FFFFFF"><input name="telefone" type="text" id="telefone" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA" value="<%=telefone%>" size="25" maxlength="20"></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td bgcolor="#FFFFFF"><input name="telefone2" type="text" id="telefone" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA" value="<%=telefone2%>" size="25" maxlength="20"></td>
                          </tr>
                          <tr>
                            <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                          </tr>
                          ...
                          <tr>
                            <td><input name="celular" type="text" id="celular" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA" value="<%=celular%>" size="25" maxlength="20"></td>
                          </tr>
                          <tr>
