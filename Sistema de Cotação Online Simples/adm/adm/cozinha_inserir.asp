...
function ValidateOrder(form)
{
  ...
  form.submit();
                ...
                <br>
                  <form method="GET" ACTION="cozinha_inserir2.asp" name="form" id="form">
                      ...
                      <table width="650" border="0" cellspacing="0" cellpadding="0">
                          <tr valign="top">
                            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="linkA">
                                ...
                                <tr>
                                  <td height="18"><input name="data" type="text" id="data" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" value="<%=datE%>" size="15" maxlength="10"></td>
                                </tr>
                                <tr>
                                  <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                                </tr>
