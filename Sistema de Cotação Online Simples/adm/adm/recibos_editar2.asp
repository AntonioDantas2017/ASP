...
'data_conv3 = split(data,"/") 'funcao utilizada para criar um vetor delimitado po "/"
'data = data_conv3(1)&"/"&data_conv3(0)&"/"&data_conv3(2) 'reorganiza data para o formato dd/mm/yy

nome_rec	=	Request("nome_rec")
cpf_rec		=	Request("cpf_rec")
rg_rec		=	Request("rg_rec")	
nome_ent	=	Request("nome_ent")
cpf_ent		=	Request("cpf_ent")
rg_ent		=	Request("rg_ent")			
referente	=	Request("referente")			

sql = "Update recibos set valor='"&valor&"',data='"&data&"',nome_rec='"&nome_rec&"',cpf_rec='"&cpf_rec&"',rg_rec='"&rg_rec&"',nome_ent='"&nome_ent&"',cpf_ent='"&cpf_ent&"',rg_ent='"&rg_ent&"',		referente='"&referente&"' where codrec="&codrec&"  "
'response.Write(sql)
...
%>
                ...
                <br>
                <br>
                O cadastro do registro foi feito com sucesso!<br>                  
<script>
	MM_openBrWindow('recibos_imp.asp?codrec=<%=codrec%>','','status=yes,scrollbars=yes,width=750,height=572');
</script>				
                <br>
                <br>
                <br>
                ...
                <br>
                  ...
                  <table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><div align="center"><a href="recibos.asp?listar=<%=listar%>&ordem=<%=ordem%>&pesquisa=<%=pesquisa%>&tipo=<%=tipo%>&filtro=<%=filtro%>&pesquisa2=<%=pesquisa2%>&datainicio=<%=datainicio%>&datafim=<%=datafim%>&filtro2=<%=filtro2%>"><img src="IMAGEM/botoes_principal.gif" alt="volta para a p&aacute;gina principal" width="75" height="19" border="0"></a></div></td>
                    </tr>
                  </table>
                  <br>
                  <br>
