...
function ValidateOrder(form)
{
  ...
  form.submit();
                ...
                <br>
                  <form method="GET" ACTION="imoveis_inserir2.asp" name="form" id="form">
                    ...
                    <tr valign="top"> 
                      <td width="100%">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="linkA">
                          ...
                          <tr> 
                            <td height="18"><input name="rua" type="text" id="rua" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" size="60" maxlength="50">
                              ( max. 50 caract. ) </td>
                          </tr>
                          <tr> 
                            <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                          ...
                          <tr> 
                            <td height="18"><input name="numero" type="text" id="numero" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" size="10" maxlength="7"  onKeyPress="return txtBoxFormat('numero', '9999999', event);">
                              ( max. 7 caract. ) </td>
                          </tr>
                          <tr> 
                            <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
                          ...
                          <tr> 
                            <td height="18"><input name="bairro" type="text" id="bairro" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" size="60" maxlength="50">
                              ( max. 50 caract. ) </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td height="18"><input name="cidade" type="text" id="cidade" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #FFC4C4" size="60" maxlength="50">
                              ( max. 50 caract. ) </td>
                          </tr>
                          <tr> 
                            <td><img src="imagem/img_transp.gif" width="1" height="2"></td>
