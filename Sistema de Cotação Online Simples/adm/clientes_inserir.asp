...
function ValidateOrder(form)
{
  ...
  form.submit();
                ...
                <br>
                  <form method="GET" ACTION="clientes_inserir2.asp" name="form" id="form">
                  ...
                  <table width="650" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                      <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="linkA">
                          ...
                          <tr>
                            <td width="28%" bgcolor="#CCCCCC"><strong>TELEFONE 1 </strong></td>
                            <td width="31%" bgcolor="#CCCCCC"><div align="left"><strong>TELEFONE 2 </strong></div></td>
                          ...
                          <tr>
                            <td bgcolor="#FFFFFF"><input name="tel" type="text" id="tel" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA" value="<%=tel%>" size="16" maxlength="14" onKeyPress="return txtBoxFormat('tel', '(99) 9999-9999', event);">
                              (00) 0000-0000 </td>
                          ...
                          <tr>
                            ...
                            <td><select name="estado" id="estado" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #EAEAEA">
                                ...
                                <option value="RN" <%if estado="RN" or estado = "" then%> selected <%end if%>>Rio Grande do Norte</option>
