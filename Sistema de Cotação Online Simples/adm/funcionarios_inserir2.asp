...
set objRs01 = objconn01.execute("INSERT INTO  Funcionarios(codfunc,nome,nomeresumido,login,senha,nivel_vendas,nivel_clientes,nivel_telefones,nivel_avisos,nivel_usuarios,nivel_log,nivel_produtos,nivel_pagamentos) values ('"&maxcodfunc&"','"&nome&"','"&nomeresumido&"','"&login&"','"&senha&"','"&nivel_vendas&"','"&nivel_clientes&"','"&nivel_telefones&"','"&nivel_avisos&"','"&nivel_usuarios&"','"&nivel_log&"','"&nivel_produtos&"','"&nivel_pagamentos&"') ")
