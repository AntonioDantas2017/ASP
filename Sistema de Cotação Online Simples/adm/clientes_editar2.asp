...
sql = "Update clientes set nome='"&nome&"',tel1='"&tel1&"',tel2='"&tel2&"',endereco='"&endereco&"',cel='"&celular&"',bairro='"&bairro&"',cidade='"&cidade&"',estado='"&estado&"',contato='"&contato&"',obs='"&obs&"' where codcli="&codcli&"  "
'response.Write(sql)
...
%>
                ...
                <br>
                  ...
                  <table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><div align="center"><a href="clientes.asp?listar=<%=listar%>&ordem=<%=ordem%>&pesquisa=<%=pesquisa%>&tipo=<%=tipo%>&filtro=<%=filtro%>&pesquisa2=<%=pesquisa2%>&datainicio=<%=datainicio%>&datafim=<%=datafim%>&filtro2=<%=filtro2%>"><img src="IMAGEM/botoes_principal.gif" alt="volta para a p&aacute;gina principal" width="75" height="19" border="0"></a></div></td>
                    </tr>
                  </table>
                  <br>
                  <br>
