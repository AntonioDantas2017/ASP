                        ...
                        <div align="center"> <br>
                          <table width="600" border="0" cellspacing="0" cellpadding="0" class=linka>
                            <tr valign="top"> 
							  ...
							  <!--<img src="imagem/TECLADO2.jpg" width="65" height="90" border="0" name="Teclado" usemap="#tecladoMapMap"> 
...
<!--<input  name="senha" type="PASSWORD" id="senha" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #F2F2F2"  tabindex="2" onBlur="if(!bchange){window.document.FLogin.IDPRESP.focus()}" size="10" maxlength="8" onKeyPress="return false;">
-->
<input  name="senha" type="PASSWORD" id="senha" style="FONT-FAMILY: Verdana; FONT-SIZE: 10px; BACKGROUND-COLOR: #F2F2F2"  tabindex="2" onBlur="if(!bchange){window.document.FLogin.IDPRESP.focus()}" size="10" maxlength="8" >
                                <table width="30%" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
